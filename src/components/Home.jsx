...
function Home() {
  return (
    <div className='text-white flex justify-around items-center pt-32'>
        ...
        <div className='mb-16 '>
            <h1 className='font-semibold text-6xl'>View and Create <br></br><span className='font-thin text-sky-400'>unique NFT </span>files.</h1>
            <p className='pt-8 text-xl font-thin'> NFTs are used for digital art and collectibles, GameFi <br></br> projects, metaverses, and more.</p>
